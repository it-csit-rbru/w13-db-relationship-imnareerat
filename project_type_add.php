                ...
                <?php
                    if(isset($_GET['submit'])){
                        ...
                        if (mysqli_query($conn,$sql)){
                            ...
                            echo "เพิ่มประเภทโครงงาน $ptt_name ผิดพลาด<br>";
                        }
                            mysqli_close($conn);
                        echo '<a href="project_type_list.php">แสดงข้อมูลประเภทโครงงานทั้งหมด</a>';
                    }else{
                ?>
                    <form class="form-horizontal" role="form" name="project_type_add" action="<?php echo $_SERVER['PHP_SELF']?>">
