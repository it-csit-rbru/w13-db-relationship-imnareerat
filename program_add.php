            ...
            <div class="row">
                ...
                <?php
                    if(isset($_GET['submit'])){
                        ...
                        $sql = "insert into program (prg_name) values ('$prg_name')";
                        echo $sql;
                        include 'connectdb.php';
                        if (mysqli_query($conn,$sql)){
                            echo "เพิ่มข้อมูลสาขาวิชา $prg_name เรียบร้อยแล้ว<br>";
                        }else{
                            echo "เพิ่มข้อมูลสาขาวิชา $prg_name ผิดพลาด<br>";
                        }
                            mysqli_close($conn);
                        echo '<a href="program_list.php">แสดงข้อมูลสาขาวิชาทั้งหมด</a>';
                    }else{
                ?>
