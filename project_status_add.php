    ...
    <body>        
        <div class="container">
            ...
            <div class="row">
                ...
                <h4>เพิ่มข้อมูลสถานะโครงการ</h4>    
                <?php
                    if(isset($_GET['submit'])){
                        $pst_name = $_GET['pst_name'];
                        $sql = "insert into project_status (pst_name) values ('$pst_name')";
                        echo $sql;
                        include 'connectdb.php';
                        if (mysqli_query($conn,$sql)){
                            echo "เพิ่มสถานะโครงการ $pst_name เรียบร้อยแล้ว<br>";
                        }else{
                            echo "เพิ่มสถานะโครงการ $pst_name ผิดพลาด<br>";
                        }
                            mysqli_close($conn);
                        echo '<a href="project_status_list.php">แสดงสถานะโครงการทั้งหมด</a>';
                    }else{
                ?>
